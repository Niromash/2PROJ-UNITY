...
public class EntityStrengthWeakness
{
    ...
    public EntityStrengthWeakness()
    {
        ...
        SetStrengthWeakness(EntityTypes.Support, EntityTypes.Tank, 0.5f);
        SetStrengthWeakness(EntityTypes.Support, EntityTypes.Infantry, 0.5f);
        SetStrengthWeakness(EntityTypes.Support, EntityTypes.AntiArmor, 1.5f);
